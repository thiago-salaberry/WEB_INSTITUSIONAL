<header class="navbar">
    <div class="navbar-container">
        ...
        <nav class="mobile-menu" id="mobileMenu">
            ...
            <a href="https://eest.tecnica1vl.org/tecmood/login/index.php" class="menu-btn moodle-btn" data-section="moodle">Moodle</a>
        </nav>
        ...
        <nav class="main-menu">
            ...
            <a href="https://eest.tecnica1vl.org/tecmood/login/index.php" class="menu-btn moodle-btn" data-section="moodle">
                <span>Moodle</span>
            </a>
        </nav>
    </div>
